...
(function(download) {
  ...
  function updateDownloadButtons() {
    ...
    if (!activeType) {
      document.querySelectorAll('.download-btn-list[data-module="compare"]').forEach(btn => btn.disabled = true);
      return;
    }
    document.querySelectorAll('.download-btn-list[data-module="compare"]').forEach(btn => {
