...
(function(download) {
  ...
  function updateDownloadButtons() {
    ...
    if (!activeType) {
      document.querySelectorAll('.download-btn[data-module="compare"]').forEach(btn => btn.disabled = true);
      return;
    }
    document.querySelectorAll('.download-btn[data-module="compare"]').forEach(btn => {
