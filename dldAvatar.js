...
(function(avatarDownload) {
  ...
  function addAvatarButtons() {
    ...
    // Create avatar download section
    ...
    if (container) {
      container.insertBefore(avatarSection, container.firstChild);
      console.log('Avatar buttons inserted');
    } else {
      downloadSection.appendChild(avatarSection);
      console.log('Avatar buttons appended');
    }
    
    // Add event listeners with DIRECT onclick binding
    ...
    if (enrichedBtn) {
      enrichedBtn.onclick = function(e) {
        e.preventDefault();
        e.stopPropagation();
        console.log('Enriched button clicked - opening modal');
        avatarDownload.downloadEnrichedAvatars();
      };
      console.log('Enriched button listener attached');
    }
    ...
    if (filteredBtn) {
      filteredBtn.onclick = function(e) {
        e.preventDefault();
        e.stopPropagation();
        console.log('Filtered button clicked - opening modal');
        avatarDownload.downloadFilteredAvatars();
      };
      console.log('Filtered button listener attached');
    }
  }
